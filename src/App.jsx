        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-20">
            ...
            <div className="flex gap-4 justify-center">
              <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg hover:shadow-lg hover:shadow-purple-500/50 transition transform hover:scale-105 font-semibold">
                View My Work
              </button>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project) => (
              <div
                key={project.id}
                className="bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-xl overflow-hidden hover:border-purple-400/50 transition cursor-pointer group"
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="bg-gradient-to-r from-purple-600/30 to-pink-600/30 backdrop-blur border border-purple-500/30 rounded-2xl p-12 text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <button className="px-8 py-3 border border-slate-500 rounded-lg hover:border-purple-400 transition font-semibold flex items-center gap-2">
                🔗 GitHub Profile
              </button>
            </div>
          </div>
